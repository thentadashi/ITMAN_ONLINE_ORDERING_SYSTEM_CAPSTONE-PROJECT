                      ...
                      <label >
                        ...
                        <div class="panel"> 
                                <div class="panel-body">
                                    <div class="form-group ">
                                      <label>Address where to deliver (Around Pangasinan Only)</label>

                                    
                                        <div class="col-md-12">
                                          <label class="col-md-4 control-label" for=
                                          "PLACE">Municipality/City</label>
                                          ...
                                          <div class="col-md-8">
                                           <input class="form-control paymethod" name="BRGY" id="BRGY" value=" <?php echo $singlecustomer->BRGYADD;?>"onchange="validatedate()">
